...
export default function Home(){
  return (<main>
    <header className="sticky top-0 z-10 backdrop-blur border-b border-[#1e2740] bg-[#0f1520]/60">
    ...
    <section className="hero-grid">
      ...
      <div className="relative h-72 md:h-96">
        <div className="absolute -top-2 left-10 w-56 h-56 rounded-full blur-3xl opacity-70" style={{background:'radial-gradient(circle,#ffffff,#9cf7ff 30%,transparent 60%)'}}/>
        <div className="absolute bottom-2 right-2 w-72 h-72 rounded-full blur-3xl opacity-70" style={{background:'radial-gradient(circle,#ffffff,#a6b1ff 30%,transparent 65%)'}}/>
        <div className="absolute top-1/2 left-1/3 w-44 h-44 rounded-full blur-2xl opacity-70" style={{background:'radial-gradient(circle,#ffffff,#d0a6ff 30%,transparent 60%)'}}/>
      </div>
    </section>
      ...
      <div className="grid md:grid-cols-2 gap-6">
        <div>
          ...
          <ul className="mt-4 space-y-2">
            <li className="relative border border-[#1f2942] rounded-lg bg-[#111827] px-3 py-2"><span className="absolute inset-y-0 left-0 w-[28%] bg-gradient-to-r from-[var(--grad1)] to-[var(--grad2)] opacity-25 rounded-l-lg"></span>Fellesskap & insentiver – 28%</li>
            <li className="relative border border-[#1f2942] rounded-lg bg-[#111827] px-3 py-2"><span className="absolute inset-y-0 left-0 w-[22%] bg-gradient-to-r from-[var(--grad1)] to-[var(--grad2)] opacity-25 rounded-l-lg"></span>Likviditet & market making – 22%</li>
            <li className="relative border border-[#1f2942] rounded-lg bg-[#111827] px-3 py-2"><span className="absolute inset-y-0 left-0 w-[20%] bg-gradient-to-r from-[var(--grad1)] to-[var(--grad2)] opacity-25 rounded-l-lg"></span>Utvikling – 20%</li>
            <li className="relative border border-[#1f2942] rounded-lg bg-[#111827] px-3 py-2"><span className="absolute inset-y-0 left-0 w-[15%] bg-gradient-to-r from-[var(--grad1)] to-[var(--grad2)] opacity-25 rounded-l-lg"></span>Partnerskap – 15%</li>
            <li className="relative border border-[#1f2942] rounded-lg bg-[#111827] px-3 py-2"><span className="absolute inset-y-0 left-0 w-[15%] bg-gradient-to-r from-[var(--grad1)] to-[var(--grad2)] opacity-25 rounded-l-lg"></span>Team & rådgivere – 15%</li>
          </ul>
        </div>
        <div className="card">
